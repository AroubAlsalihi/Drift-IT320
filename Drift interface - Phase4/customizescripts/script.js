...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const carConfigurations = {
        ...
        blue: {
            ...
            rim2: {
                ...
                thumbnails: [
                   "img/Q5blue-rim2.png",
                   "img/Q5blue1-rim2.png",
                   "img/Q5blue2-rim2.png",
                   "img/Q5blue3-rim2.png",
        ...
        green: {
            ...
            rim3: {
                ...
                thumbnails: [
                   ...
                   "img/Q5green1-rim3.png",
                   "img/Q5green2-rim3.png",
                   "img/Q5green3-rim3.png",
            ...
            rim4: {
                ...
                thumbnails: [
                    ...
                    "img/Q5green1-rim4.png",
                    "img/Q5green2-rim4.png",
                    "img/Q5green3-rim4.png",
    ...
    function updateCarImages() {
        if (carConfigurations[selectedColor] && carConfigurations[selectedColor][selectedWheel]) {
            const config = carConfigurations[selectedColor][selectedWheel];
            mainCarImage.src = config.main;
            selectedImage = config.main;
    
            window.selectedImage = config.main; 
            thumbnails.forEach((thumb, index) => {
                thumb.src = config.thumbnails[index];
            });
        }
    }
