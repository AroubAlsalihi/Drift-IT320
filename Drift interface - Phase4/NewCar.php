<?php
// connection.php included for database connection
include('connection.php');
include ('handleLogOut.php');

// Query to fetch new cars
...
<header class="header" id="header">
        <nav class="nav container">
            ...
            <div class="nav__menu" id="nav-menu">
                <ul class="nav__list">
                    ...
                    <li class="nav__item">
                        <a href="NewCar.php" class="nav__link active-link">New Cars</a>
                    </li>
                    <li class="nav__item">
  ...
  <div id="searchDropdown" class="search-dropdown" style="display:none;"></div>
    ...
    <section class="category section">
        <h2 class="section__title">Explore New Cars</h2>
            ...
            if ($result && $result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    echo '<article class="category__card">
                            ...
                            <a href="ProductPage.php?id=' . $row['Car_Id'] . '" class="button">View Details</a>
                          </article>';
                }
            }
